public class Apartment1 extends Backgrounds{
    ...
    public Apartment1(){
        ...
        setDoor(new Doors("assets/backgrounds/1staptdoor.png", new OUTAPT1(), x+240*2, y+185*2, dx, dy, 75, 89, false));
        ...
        props.add(new Props("assets/backgrounds/props/apt1table.png", x+468*2, y+345*2, 0, 0, 147, 10, false));
    }
